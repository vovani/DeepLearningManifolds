function [X_tr, X_te,S] = read_mnist_sphere(path_to_mnist, options)
...
% [xifres] = readidx(fullfile(path_to_mnist,'mnist','train-images.idx3-ubyte'),60000,60000);
 ...
 xifres = loadMNISTImages('train-images.idx3-ubyte');
...
[xifres] = loadMNISTImages('t10k-images.idx3-ubyte');
